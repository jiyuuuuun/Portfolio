  ...
  const certificates = [
    {
      ...
      issuer: "한국정보통신진흥협회",
      date: "2023.10",
      description: "리눅스 기반 시스템 운영 및 관리에 대한 이론과 실무 능력 인증"
      ...
      <div className="w-full">
        ...
        <div className="space-y-6">
          {certificates.map((cert, idx) => (
            <div key={idx} className="bg-white border border-gray-200 rounded-lg p-6 transition-all duration-300 hover:shadow-md">
