    ...
    <div className="flex flex-col h-full">
      <div className="flex flex-col items-center text-center gap-4">
        ...
        <div className="space-y-1">
          <h1 className="text-2xl font-bold text-gray-800">황지윤</h1>
          <p className="text-base text-gray-600">꾸준함으로 성장중인</p>
          <p className="text-base text-gray-600">백엔드 개발자 황지윤입니다</p>
        </div>
        ...
        <div className="flex flex-wrap gap-1.5 justify-center">
          <span className="px-2.5 py-0.5 bg-gray-200 text-gray-700 rounded-full text-xs font-medium">Java</span>
          <span className="px-2.5 py-0.5 bg-gray-200 text-gray-700 rounded-full text-xs font-medium">Spring</span>
          <span className="px-2.5 py-0.5 bg-gray-200 text-gray-700 rounded-full text-xs font-medium">MySQL</span>
          <span className="px-2.5 py-0.5 bg-gray-200 text-gray-700 rounded-full text-xs font-medium">Docker</span>
        </div>
      </div>
      ...
      <div className="mt-auto pt-4 border-t border-gray-200 mx-4">
        <p className="text-xs text-gray-500 mt-2 text-center">© 2024 황지윤</p>
      </div>
    </div>
  );
} 